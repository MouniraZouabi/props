...
<Card border="primary" style={{width: '40rem', textAlign: 'center', marginLeft: '500px', borderRadius: '10%'}}>
        ...
        <Card.Body style={{background:'lightgray'}}>
          ...
          <Card.Text style={{color:'', background:'',fontFamily:'fangsong' ,fontSize: '18px'}}>
          {props.bio} 
          </Card.Text>
        </Card.Body>
      </Card>
